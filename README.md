# jeflect [![maven-central](https://img.shields.io/maven-central/v/com.github.romanqed/jeflect/1.0.1L?color=blue)](https://repo1.maven.org/maven2/com/github/romanqed/jeflect/1.0.0L)
...
```Groovy
dependencies {
    implementation group: 'com.github.romanqed', name: 'jeflect', version: '1.0.1L'
}
```
